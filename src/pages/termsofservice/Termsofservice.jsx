    ...
    <div className="w-full px-4 sm:px-[10%] font-poppins">
      ...
      <div className="flex pb-20 sm:pb-[20%] flex-col justify-start gap-5 text-left">
        ...
        <p className="font-poppins font-medium text-[#1A1A1A] text-base sm:text-xl mb-8">
          Welcome to PahingaU. By accessing or using our website and services,
        ...
        <p className="font-poppins font-medium text-[#1A1A1A] text-base sm:text-xl mb-8">
          By using PahingaU, you represent and warrant that you are at least 18
        ...
        <p className="font-poppins font-medium text-[#1A1A1A] text-base sm:text-xl mb-8">
          PahingaU provides a platform for listing and searching for student
        ...
        <p className="font-poppins font-medium text-[#1A1A1A] text-base sm:text-xl mb-8">
          To access certain features of PahingaU, you must create an account.
          You agree to:
          <ul className="list-disc pl-5">
            <li>
        ...
        <p className="font-poppins font-medium text-[#1A1A1A] text-base sm:text-xl mb-8">
          You retain ownership of the content you post on PahingaU. By posting
        ...
        <p className="font-poppins font-medium text-[#1A1A1A] text-base sm:text-xl mb-8">
          All content and materials on PahingaU, including but not limited to
          text, graphics, logos, and software, are the property of PahingaU or
        ...
        <p className="font-poppins font-medium text-[#1A1A1A] text-base sm:text-xl">
          PahingaU is provided "as is" and "as available" without warranties of
        ...
        <p className="font-poppins font-medium text-[#1A1A1A] text-base sm:text-xl mb-8">
          In no event shall PahingaU be liable for any indirect, incidental,
        ...
        <p className="font-poppins font-medium text-[#1A1A1A] text-base sm:text-xl mb-8">
          You agree to indemnify, defend, and hold harmless PahingaU, its
        ...
        <p className="font-poppins font-medium text-[#1A1A1A] text-base sm:text-xl mb-8">
          ...
          please contact us at support@pahingau.com.
        </p>
      </div>
    </div>
  );
