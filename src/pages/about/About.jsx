...
import aboutsection3icon from "../../assets/aboutsection3icon.png";
...
import aboutsection4icon from "../../assets/aboutsection4icon.png";
import aboutsection4img from "../../assets/aboutsection4img.png";
...
const About = () => {
  return (
    <>
      ...
      <div className=" bg-cover bg-center py-16 flex justify-center items-center" style={{ backgroundImage:`url(${aboutsection3bg})` }}>
        <div className="about-section3-content w-4/5 flex flex-col lg:flex-row">
          <div className="lg:w-3/5 mb-8 lg:mb-0 text-white">
            <div className="flex items-center mb-4">
              <img src={aboutsection3icon} alt="Purple cube icon." className="w-10 h-10" />
              <h2 className="text-xl font-regular ml-3">DoorMe Features</h2>
            </div>
            <h1 className="text-4xl font-semibold mb-6">Your Ultimate Dorm Hunting Companion</h1>
          ...
          <div className="flex flex-wrap lg:flex-nowrap lg:space-x-6 space-y-6 lg:space-y-0 text-white lg:w-2/3">
            <div className="w-full lg:w-1/3 bg-transparent border border-white p-8 rounded-lg shadow-md flex flex-col items-center">
              <img src={aboutsection3column2} alt="A star shape icon." className="w-16 h-16 mb-4" />
              <h1 className="text-xl font-medium text-center mb-4">Comprehensive Listings</h1>
            </div>
            <div className="w-full lg:w-1/3 bg-transparent border border-white p-8 rounded-lg shadow-md flex flex-col items-center">
              <img src={aboutsection3column3} alt="A personalized search icon." className="w-16 h-16 mb-4" />
              <h1 className="text-xl font-medium text-center mb-4">Personalized Search</h1>
            </div>
            <div className="w-full lg:w-1/3 bg-transparent border border-white p-8 rounded-lg shadow-md flex flex-col items-center">
              <img src={aboutsection3column4} alt="A shield or badge icon." className="w-16 h-16 mb-4" />
              <h1 className="text-xl font-medium text-center mb-4">Secure and Easy</h1>
            </div>
          </div>
        </div>
      </div>
      <div className="py-40 flex justify-center items-center">
        <div className="w-4/5 flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 gap-8 lg:ml-10">
            ...
            <h1 className="text-4xl font-semibold lg:text-left text-center mb-6">Frequently asked questions</h1>
            <div className="flex flex-col space-y-6">
              {[
                "How do I search for dorms on DoorMe?",
                "How do I book a dorm through DoorMe?",
                "Is my payment information secure with DoorMe?",
                "Can I cancel or modify my visiting schedule?",
              ].map((question, index) => (
                <div key={index} className="flex items-center">
                  <div className="w-1 h-8 bg-gray-300 rounded-l-lg mr-4"></div>
                  <p className="flex-grow text-lg">{question}</p>
                  <button>
                    <img
